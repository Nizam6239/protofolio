    ...
    >
      ...
      <div className="flex space-x-4 justify-center">
        ...
        <a href="/NIZAM_Resume.pdf" download="Nizam_Resume.pdf">
          ...
          >
            <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
            <span className="flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-4 py-[1px] text-base font-medium text-white backdrop-blur-3xl">
