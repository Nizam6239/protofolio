...
export function NavbarDemo() {
  return (
    <div className="fixed flex items-center ">
      <Navbar className="top-6 flex justify-center" />
    </div>
  );
}
...
export function Navbar({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        "fixed top-10 left-0 right-0 md:mx-auto md:max-w-full flex justify-items-start sm:justify-center md:justify-center ml-24 md:ml-0",
        className
      )}
    >
